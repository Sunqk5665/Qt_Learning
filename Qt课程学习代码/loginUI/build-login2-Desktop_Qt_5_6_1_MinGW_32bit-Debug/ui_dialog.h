...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Dialog->resize(490, 303);
        Dialog->setMinimumSize(QSize(464, 0));
        Dialog->setMaximumSize(QSize(16777215, 303));
        QFont font;
        font.setPointSize(5);
        Dialog->setFont(font);
        label = new QLabel(Dialog);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(240, 20, 91, 31));
        QFont font1;
        ...
        label_3->setGeometry(QRect(140, 130, 51, 21));
        ...
        lineEdit_2->setGeometry(QRect(220, 130, 113, 20));
        lineEdit_2->setFont(font2);
        lineEdit_2->setEchoMode(QLineEdit::Password);
        pushButton = new QPushButton(Dialog);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(150, 210, 80, 31));
        pushButton->setFont(font2);
        pushButton_2 = new QPushButton(Dialog);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(290, 210, 80, 31));
